...
import { AlmanackFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = AlmanackFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new AlmanackFactory(FACTORY_ADDRESS);
